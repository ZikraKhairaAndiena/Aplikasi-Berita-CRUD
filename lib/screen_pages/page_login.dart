...
import 'package:uas_zikra_2037/screen_pages/page_bottom_navigation.dart';
import 'package:uas_zikra_2037/screen_pages/page_list_berita.dart';
import 'package:uas_zikra_2037/screen_pages/page_register.dart';
...
class _PageLoginState extends State<PageLogin> {
  ...
  Future<ModelLogin?> loginAccount() async{
    try{
      ...
      http.Response res = await http.post(Uri.parse('http://192.168.100.110/uas_mobile/login.php'),
          body: {
