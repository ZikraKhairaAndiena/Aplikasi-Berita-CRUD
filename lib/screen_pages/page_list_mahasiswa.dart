...
import 'package:uas_zikra_2037/screen_pages/page_edit_mahasiswa.dart';
import 'package:uas_zikra_2037/screen_pages/page_insert_mahasiswa.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getMahasiswa() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.100.110/uas_mobile/listmahasiswa.php'));
  ...
  Future<void> deleteMahasiswa(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.100.110/uas_mobile/deletemahasiswa.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
